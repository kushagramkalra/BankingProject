...
lb1=Label(text="AVERAGE",font=('arial',20,'bold'),bg="lightpink")
...
btn1=Button(text="SELECT",command=average,bg="orchid",width=15,height=2)
...
lb7=Label(win, text = '1) 15% rebate on medical facilities.',
                      foreground = flash_colours[0],background='lightpink')
lb7.place(x=10,y=270)
flashColour(lb7, 0)

lb8=Label(win, text = '2) 6.5% interest on all fixed deposits (one can claim the principle amount not before 1 year.)',
                      foreground = flash_colours[0],background='lightpink')
lb8.place(x=10,y=290)
flashColour(lb8, 0)

lb8=Label(win, text = '3) 10% off on all movie tickets.',
                      foreground = flash_colours[0],background='lightpink')
lb8.place(x=10,y=310)
flashColour(lb8, 0)

lb8=Label(win, text = '4) 15% off on all alternate food transections(groceris,restaurants.)',
                      foreground = flash_colours[0],background='lightpink')
lb8.place(x=10,y=330)
flashColour(lb8, 0)

lb8=Label(win, text = '5) Airport lounge access on all domestic airlines.',
                      foreground = flash_colours[0],background='lightpink')
